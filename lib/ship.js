(function () {
  ...
  Ship.prototype.fireBullet = function() {
    ...
    var bullet = new Asteroids.Bullet(this.pos.slice(),
            this.getBulletVelocity(this.rotation, 20),
            3,
            this.game);
    this.game.bullets.push(bullet);
    if (this.multiCannon) {
      var secondBullet = new Asteroids.Bullet(this.pos.slice(),
            this.getBulletVelocity(this.rotation - 10, 20),
            3,
            this.game);
  ...
  Ship.prototype.fireSnowball = function() {
    var snowball = new Asteroids.Snowball(this.pos.slice(),
      this.getBulletVelocity(this.rotation, 10),
      this.game);
  ...
  Ship.prototype.getBulletVelocity = function(rotation, multiplier) {
    return [Math.sin(this.degToRad(rotation)) * multiplier,
            Math.cos(this.degToRad(rotation)) * multiplier];
  }
